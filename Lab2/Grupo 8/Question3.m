...
%% Part 3 - Vocoder Simulation
    ...
    outfile='birthdate_75268_voc.wav';
    ...
    tt=zeros(stmo,ceil(hopout/hopin)*fix(min(leny,time*sr))); % place for output 
    ...
    %audiowrite(tt,sr,16,outfile); Quero comparar com ficheiros de saÃ­da de outros
    fclose('all');